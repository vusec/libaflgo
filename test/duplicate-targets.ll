...
; CHECK: void @callee()
; CHECK-NEXT: call void @__sanitizer_cov_trace_pc
; CHECK-NEXT: call void @__aflgo_trace_bb_distance
; CHECK-NEXT: call void @__aflgo_trace_bb_target
; CHECK-NEXT: ret void
  call void @__aflgo_trace_bb_target(i32 0)
  call void @__aflgo_trace_bb_target(i32 0)
  ret void, !dbg !12, !annotation !16
}
